...
const Header = (props) => {
  ...
  return (
    <div className=' min-h-fit bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-800'>
      <nav className='py-4 flex items-center justify-between'>
              <NavLink to='/'><h1 className='text-md font-burtons dark:text-white'>CHIKA_CODES~</h1></NavLink>
              {/* <ul className='flex items-center'> */}
                <div className="flex items-center justify-between">
                <li className="list-none mt-6">
                      <BsFillMoonStarsFill onClick={props.ToggleDarkMode} className={`cursor-pointer text-2xl mb-6 mx-4 dark:text-white lg:hidden ${props.darkMode ? "dark" : ""}`} />
                </li>
                    <section className="MOBILE-MENU flex lg:hidden">
                      ...
                      <div className={isNavOpen ? "showMenuNav" : "hideMenuNav"}>
                        ...
                        <ul className="flex flex-col items-center justify-between min-h-[250px] no-underline hover:underline">
                          <li className="border-b border-gray-400 my-8 uppercase no-underline hover:underline decoration-teal-600 underline-offset-8 decoration-2">
                    ...
                    <ul className="DESKTOP-MENU hidden space-x-8  lg:flex dark:text-white">
                      ...
                      <li className="mt-2 no-underline hover:underline decoration-teal-600">
                        <BsFillMoonStarsFill onClick={props.ToggleDarkMode} className='cursor-pointer text-2xl dark:text-white' />
                      </li>
