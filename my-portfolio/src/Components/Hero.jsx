...
const Main = () => {
  return (
    <div className='text-center p-10 mb-20 md:flex md:flex-row md:justify-between md:px-15 lg:px-20'>
        <div className=''>
            <h2 className='text-5xl py-2 text-teal-600 font-medium md:text-4xl lg:text-4xl'>Fortune Ellah</h2>
            <h3 className='text-2xl py-2 md:text-3xl lg:text-6xl'>
                Frontend Developer
            </h3>
            <p className='text-md py-5 px-2 max-w-sm leading-8 text-gray-800 md:text-xl md:max-w-xl md:mx-auto'>
